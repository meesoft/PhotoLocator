...
namespace PhotoLocator.BitmapOperations
{
    static class ResizeBilinearOperation
    {
        ...
        /// </summary>
        public static ROI GetSourceROI(FloatBitmap src, FloatBitmap dst, ROI dstROI)
        {
        ...
        /// Determine source ROI given destination ROI
        /// </summary>
        public static ROI GetSourceROI(BitmapPlaneInt16 src, BitmapPlaneInt16 dst, ROI dstROI)
        {
            float scaleX = 0, scaleY = 0;
            if (dst.Width > 1)
                scaleX = (float)(src.Width - 1) / (dst.Width - 1);
