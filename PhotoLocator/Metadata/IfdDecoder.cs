...
#pragma warning restore CA2213 // Disposable fields should be disposed
        ...
        public record IfdTag(short TagId, FieldType FieldType, int ValueCount, uint ValueOrOffset);
        ...
        public IEnumerable<IfdTag> EnumerateIfdTags()
        {
            ...
            do
            {
                ...
                var ifdFieldCount = _reader.ReadInt16();
                for (var i = 0; i < ifdFieldCount; i++)
                {
                    if (_stream.Position + 12 > length)
                        yield break;
                    yield return new IfdTag(_reader.ReadInt16(), (FieldType)_reader.ReadInt16(), _reader.ReadInt32(), _reader.ReadUInt32());
                }
